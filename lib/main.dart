...
class _HomePageState extends State<HomePage> {
  ...
  void generateModel() {
    try {
      ...
      if (json is Map<String, dynamic>) {
        final code = generateFreezedModel(className: className, json: json);
        setState(() {
          generatedCode = code;
        });
      } else {
  ...
  void downloadFile() {
    final fileName = "${_classNameController.text.toLowerCase()}.dart";
    final blob = html.Blob([generatedCode]);
